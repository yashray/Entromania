				...
				<div class="static-content">
					<div class="page-content">
						<ol class="breadcrumb">
							...
							<li class="active"><a href="add-city.jsp">Add City</a></li>
												...
												<div class="tab-content">
													<div class="tab-pane active" id="horizontal-form">
														<form class="form-horizontal"
															action="<%=request.getContextPath()%>/cityCo"
															method="post">
															...
															<div class="form-group mb-n">
																<label for="largeinput"
																	...
																	State</label>
																<div class="col-sm-8">
																	<select name="s_id" id="selector1" class="form-control">
																		<c:forEach items="${sessionScope.search_state}"
																			var="s">
															...
															<div class="form-group mb-n">
																<label for="largeinput"
																	class="col-sm-2 control-label label-input-lg">City
																	Name</label>
																<div class="col-sm-8">
																	<input type="text" name="city"
																		class="form-control input-lg" id="largeinput"
															...
															<div class="form-group mb-n">
																<label for="largeinput"
																	class="col-sm-2 control-label label-input-lg">Pincode</label>
																<div class="col-sm-8">
															...
															<div class="row">
																<div class="col-sm-8 col-sm-offset-2">
																	<button class="btn-primary btn">Add City</button>
