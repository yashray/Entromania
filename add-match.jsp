...
<li class="active"><a href="add-match.jsp">Add Match</a></li>
				...
				<div class="panel-body">
					<div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" action="<%=request.getContextPath()%>/matchCo" method="post">
							<div class="form-group mb-n">
									<label for="largeinput" class="col-sm-2 control-label label-input-lg">Title</label>
									<div class="col-sm-8">
										<input type="text" name="title" class="form-control input-lg" name="title" id="largeinput" placeholder="Enter Title for Match" required>
									</div>
								 </div> <br/>
								 <div class="form-group mb-n">
									<label for="largeinput" class="col-sm-2 control-label label-input-lg">Team 1</label>
									<div class="col-sm-8">
										<input type="text"  class="form-control input-lg" name="team1" id="largeinput" placeholder="Enter Team 1" required>
									</div>
								 </div> <br/>
								 <div class="form-group mb-n">
									<label for="largeinput" class="col-sm-2 control-label label-input-lg">Team 2</label>
									<div class="col-sm-8">
										<input type="text" class="form-control input-lg" name="team2" id="largeinput" placeholder="Enter Team 2" required>
									</div>
								 </div> <br/>
								 <div class="form-group mb-n">
								    <label for="largeinput" class="col-sm-2 control-label label-input-lg">Select Stadium</label>
									<div class="col-sm-8">
									<select name="stadiumid" id="selector1" class="form-control">
								  ...
								  <div class="form-group mb-n">
                            		...
                            		<div class="col-sm-6">
                                		<input type="date" name="date" class="form-control input-lg" data-inputmask="'alias':'date'" required>
                            		</div>
                       			 </div> <br>
                       
                        <div class="form-group mb-n">
									<label for="largeinput" class="col-sm-2 control-label label-input-lg">Time</label>
									<div class="col-sm-8">
										<input type="time" name="time" class="form-control input-lg" id="largeinput" placeholder="Enter Timing Of Match" required>
									</div>
								 </div> <br/>
								 <div class="form-group">
					<label for="col-sm-2 mb-n" class="col-sm-2 control-label label-input-lg">Match Desription</label>
					<div class="col-sm-8">
						<textarea name="m_des" class="form-control autosize" required></textarea>
					</div>
				</div>
					...
					<div class="row">
						<div class="col-sm-8 col-sm-offset-2">
							<button class="btn-primary btn" name="flag" value="insertmatch" >Add Match</button>
