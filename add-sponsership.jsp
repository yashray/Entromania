...
<li class="active"><a href="add-sponsership.jsp">Add Sponser</a></li>
				...
				<div class="panel-body">
					<div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" action="<%=request.getContextPath()%>/SponserCo" method="post" enctype="multipart/form-data">
								
								<div class="form-group mb-n">
									<label for="largeinput" class="col-sm-2 control-label label-input-lg">Sponser Name</label>
									<div class="col-sm-8">
										<input type="text" class="form-control input-lg" name="sponserName" id="largeinput" placeholder="Enter Title" required>
									</div>
								</div> <br/>
					...
					<div class="row">
						<div class="col-sm-8 col-sm-offset-2">
							<button class="btn-primary btn" name="flag" value="addSponser">Add Sponser</button>
